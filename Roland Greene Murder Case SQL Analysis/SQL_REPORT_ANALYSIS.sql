...
AND a.success_flag = 'True'
ORDER BY a.access_time
) TO 'C:\Users\USER\Desktop\PORTFOLIO PROJECT\SQL\Forensic Analysis\Exportdata/vault_access.csv' WITH CSV HEADER;
...
WHERE c.recipient_relation = 'Victim'
AND c.call_timestamp BETWEEN '2025-06-01 19:50:00' AND '2025-06-01 20:10:00'
) TO 'C:\Users\USER\Desktop\PORTFOLIO PROJECT\SQL\Forensic Analysis\Exportdata/victim_calls.csv' WITH CSV HEADER;

COPY forensic_events TO 'C:\Users\USER\Desktop\PORTFOLIO PROJECT\SQL\Forensic Analysis\Exportdata/forensic_events.csv' WITH CSV HEADER;
...
AND (s.alibi ILIKE '%home%' OR s.alibi ILIKE '%hospital%' OR s.alibi ILIKE '%left%')
ORDER BY s.suspect_id
) TO 'C:\Users\USER\Desktop\PORTFOLIO PROJECT\SQL\Forensic Analysis\Exportdata/false_alibis.csv' WITH CSV HEADER;
...
ORDER BY a.access_time
) TO 'C:\Users\USER\Desktop\PORTFOLIO PROJECT\SQL\Forensic Analysis\Exportdata/subsequent_access.csv' WITH CSV HEADER;
